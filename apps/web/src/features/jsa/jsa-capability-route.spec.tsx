...
describe('JSA capability route', () => {
  beforeEach(() => vi.clearAllMocks());
  it('renders the workspace only for the configured capability', async () => {
  ...
  it('explains fail-closed configuration', async () => {
    vi.mocked(jsaApi.capabilities).mockResolvedValue({
      view: false,
      create: false,
      edit: false,
    ...
    renderRoute();
    expect(
      await screen.findByText('JSA permission-code mapping is not configured'),
    ).toBeInTheDocument();
  });
});
