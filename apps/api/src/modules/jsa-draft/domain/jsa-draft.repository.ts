...
} from './jsa-draft.types';
export const JSA_DRAFT_REPOSITORY = Symbol('JSA_DRAFT_REPOSITORY');
export interface DraftLoadRecord {
  header: JsaDraftHeader;
  prompts: JsaDraftPrompt[];
  tasks: JsaDraftTask[];
  coverage: JsaPromptCoverage[];
  steps: JsaDraftBasicStep[];
  procedures: JsaDraftProcedureReference[];
